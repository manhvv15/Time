...
namespace ChamCong365.OOP.NhanVien.DonDeXuat
{
    public class DonNghiPhep
    {
        ...
        public class DataAPI_NghiPhep
        {
            public bool result { get; set; }
            public string message { get; set; }
            public SaveDX saveDX { get; set; }
            public List<SaveCreateTb> saveCreateTb { get; set; }
        }
        ...
        public class API_NghiPhep
        {
            public DataAPI_NghiPhep data { get; set; }
            public object error { get; set; }
        }

        public class SaveCreateTb
        {
            public int _id { get; set; }
            public int id_user { get; set; }
            public int id_user_nhan { get; set; }
            public int id_van_ban { get; set; }
