...
namespace ChamCong365.OOP.CaiDatLuong.CongCong
{
    public class clsDSCongCong
    {
        ...
        public class Data
        {
            public List<ListDexuat> list_dexuat { get; set; }
        }

        public class DiMuonVeSom
        {
            public object time_batdau { get; set; }
            public bool time_batdau_tomorrow { get; set; }
            public object time_ketthuc { get; set; }
            public bool time_ketthuc_tomorrow { get; set; }
        ...
        public class ListDexuat
        {
            ...
            public List<UserDuyet> userDuyet { get; set; }
        }
