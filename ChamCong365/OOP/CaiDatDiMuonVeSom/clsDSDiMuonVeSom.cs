...
namespace ChamCong365.OOP.CaiDatDiMuonVeSom
{
    public class clsDSDiMuonVeSom
    {
        ...
        public class ListDataLateEarly
        {
            ...
            public int ep_idCom { get; set; }
            public string ep_idChat { get; set; }
            ...
            public string monetary_fine { get; set; }
        }
